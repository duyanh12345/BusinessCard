...
function Desription() {
    return (
        <div className="Description">
            <p className="Name">I am Lazy</p>
            <p className="Job">BUILD</p>
            <div className="container">
                <a href='mailto:da2432003@gmail.com' className="Email">
                ...
                <a href='https://www.linkedin.com/in/duyanh-dao-522b2927a/' className="LinkedIn" >
